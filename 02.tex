...
loads and stores, like arithmetic, logic\todol{, and address generation}.
...
\todol{Which is much less than the achieved performance on HSW-S architecture. We don't know why. Some data, probably the array idx might be kept in cache, but this is only a speculation.}
