...
$AX=B$ with multiple right-hand sides, using a parallel $LU$, $LDL^T$ or $LL^T$
factorization, where $A$ and $X,\,B$ are $n$ by $n$ and $n$ by $nrhs$ matrices
respectively. PARDISO supports a wide range of sparse matrix types and
