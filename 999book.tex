...
Another application domain relying on efficient direct sparse solvers stem from applying interior point methods to problems in power grid sector (\cite{8846109}).
